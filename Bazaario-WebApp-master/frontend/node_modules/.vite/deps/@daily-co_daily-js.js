...
var Ai = "cam-in-use";
var ji = "mic-in-use";
var Ii = "cam-mic-in-use";
var xi = "permissions";
var Li = "undefined-mediadevices";
var Di = "not-found";
var Ni = "constraints";
var Ri = "unknown";
...
var no = "meeting-session-data-error";
...
var za = { customIntegrations: { validate: gc, help: fc() }, customTrayButtons: { validate: vc, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify($a)) }, url: { validate: function(e2) {
...
export {
  vi as DAILY_ACCESS_LEVEL_FULL,
  gi as DAILY_ACCESS_LEVEL_LOBBY,
  mi as DAILY_ACCESS_LEVEL_NONE,
  fi as DAILY_ACCESS_UNKNOWN,
  Ii as DAILY_CAMERA_ERROR_CAM_AND_MIC_IN_USE,
  Ai as DAILY_CAMERA_ERROR_CAM_IN_USE,
  Ni as DAILY_CAMERA_ERROR_CONSTRAINTS,
  ji as DAILY_CAMERA_ERROR_MIC_IN_USE,
  Di as DAILY_CAMERA_ERROR_NOT_FOUND,
  xi as DAILY_CAMERA_ERROR_PERMISSIONS,
  Li as DAILY_CAMERA_ERROR_UNDEF_MEDIADEVICES,
  Ri as DAILY_CAMERA_ERROR_UNKNOWN,
  Zi as DAILY_EVENT_ACCESS_STATE_UPDATED,
  Eo as DAILY_EVENT_ACTIVE_SPEAKER_CHANGE,
  To as DAILY_EVENT_ACTIVE_SPEAKER_MODE_CHANGE,
  yo as DAILY_EVENT_APP_MSG,
  zi as DAILY_EVENT_CAMERA_ERROR,
  Ao as DAILY_EVENT_CPU_LOAD_CHANGE,
  Jo as DAILY_EVENT_ERROR,
  xo as DAILY_EVENT_EXIT_FULLSCREEN,
  jo as DAILY_EVENT_FACE_COUNTS_UPDATED,
  Io as DAILY_EVENT_FULLSCREEN,
  Bi as DAILY_EVENT_IFRAME_LAUNCH_CONFIG,
  Fi as DAILY_EVENT_IFRAME_READY_FOR_LAUNCH_CONFIG,
  Uo as DAILY_EVENT_INPUT_SETTINGS_UPDATED,
  Hi as DAILY_EVENT_JOINED_MEETING,
  Wi as DAILY_EVENT_JOINING_MEETING,
  Fo as DAILY_EVENT_LANG_UPDATED,
  Gi as DAILY_EVENT_LEFT_MEETING,
  Ro as DAILY_EVENT_LIVE_STREAMING_ERROR,
  Lo as DAILY_EVENT_LIVE_STREAMING_STARTED,
  No as DAILY_EVENT_LIVE_STREAMING_STOPPED,
  Do as DAILY_EVENT_LIVE_STREAMING_UPDATED,
  $i as DAILY_EVENT_LOADED,
  Vi as DAILY_EVENT_LOADING,
  Ji as DAILY_EVENT_LOAD_ATTEMPT_FAILED,
  Co as DAILY_EVENT_LOCAL_SCREEN_SHARE_CANCELED,
  ko as DAILY_EVENT_LOCAL_SCREEN_SHARE_STARTED,
  Mo as DAILY_EVENT_LOCAL_SCREEN_SHARE_STOPPED,
  no as DAILY_EVENT_MEETING_SESSION_DATA_ERROR,
  to as DAILY_EVENT_MEETING_SESSION_STATE_UPDATED,
  eo as DAILY_EVENT_MEETING_SESSION_SUMMARY_UPDATED,
  Po as DAILY_EVENT_NETWORK_CONNECTION,
  Oo as DAILY_EVENT_NETWORK_QUALITY_CHANGE,
  Vo as DAILY_EVENT_NONFATAL_ERROR,
  Xi as DAILY_EVENT_PARTICIPANT_COUNTS_UPDATED,
  Qi as DAILY_EVENT_PARTICIPANT_JOINED,
  Yi as DAILY_EVENT_PARTICIPANT_LEFT,
  Ki as DAILY_EVENT_PARTICIPANT_UPDATED,
  Bo as DAILY_EVENT_RECEIVE_SETTINGS_UPDATED,
  mo as DAILY_EVENT_RECORDING_DATA,
  vo as DAILY_EVENT_RECORDING_ERROR,
  po as DAILY_EVENT_RECORDING_STARTED,
  fo as DAILY_EVENT_RECORDING_STATS,
  ho as DAILY_EVENT_RECORDING_STOPPED,
  go as DAILY_EVENT_RECORDING_UPLOAD_COMPLETED,
  _o as DAILY_EVENT_REMOTE_MEDIA_PLAYER_STARTED,
  So as DAILY_EVENT_REMOTE_MEDIA_PLAYER_STOPPED,
  wo as DAILY_EVENT_REMOTE_MEDIA_PLAYER_UPDATED,
  qi as DAILY_EVENT_STARTED_CAMERA,
  Ui as DAILY_EVENT_THEME_UPDATED,
  so as DAILY_EVENT_TRACK_STARTED,
  ao as DAILY_EVENT_TRACK_STOPPED,
  uo as DAILY_EVENT_TRANSCRIPTION_ERROR,
  bo as DAILY_EVENT_TRANSCRIPTION_MSG,
  co as DAILY_EVENT_TRANSCRIPTION_STARTED,
  lo as DAILY_EVENT_TRANSCRIPTION_STOPPED,
  ro as DAILY_EVENT_WAITING_PARTICIPANT_ADDED,
  oo as DAILY_EVENT_WAITING_PARTICIPANT_REMOVED,
  io as DAILY_EVENT_WAITING_PARTICIPANT_UPDATED,
  Pi as DAILY_FATAL_ERROR_CONNECTION,
  _i as DAILY_FATAL_ERROR_EJECTED,
  Ti as DAILY_FATAL_ERROR_EOL,
  ki as DAILY_FATAL_ERROR_EXP_ROOM,
  Mi as DAILY_FATAL_ERROR_EXP_TOKEN,
  Ei as DAILY_FATAL_ERROR_MEETING_FULL,
  wi as DAILY_FATAL_ERROR_NBF_ROOM,
  Si as DAILY_FATAL_ERROR_NBF_TOKEN,
  Oi as DAILY_FATAL_ERROR_NOT_ALLOWED,
  Ci as DAILY_FATAL_ERROR_NO_ROOM,
  bi as DAILY_RECEIVE_SETTINGS_ALL_PARTICIPANTS_KEY,
  yi as DAILY_RECEIVE_SETTINGS_BASE_KEY,
  ai as DAILY_STATE_ERROR,
  oi as DAILY_STATE_JOINED,
  ii as DAILY_STATE_JOINING,
  si as DAILY_STATE_LEFT,
  ti as DAILY_STATE_NEW,
  ci as DAILY_TRACK_STATE_BLOCKED,
  pi as DAILY_TRACK_STATE_INTERRUPTED,
  di as DAILY_TRACK_STATE_LOADING,
  li as DAILY_TRACK_STATE_OFF,
  hi as DAILY_TRACK_STATE_PLAYABLE,
  ui as DAILY_TRACK_STATE_SENDABLE,
  Ha as default
};
