  ...
  return (
    <div className="h-screen w-full bg-slate-900 relative overflow-hidden flex flex-col font-sans">
      ...
      <div className="flex-1 relative">
         <img 
           src={user?.role === 'seller' 
             ? "https://ui-avatars.com/api/?name=Customer&background=random" // Seller sees customer
             : "https://images.unsplash.com/photo-1607346256330-dee7af15f7c5?q=80&w=1000&auto=format&fit=crop" // Buyer sees seller/shop
           }
           alt="Remote Stream" 
      ...
      {/* Local Video (PiP) */}
      {camOn && (
        <div className="absolute top-24 left-4 w-32 h-48 bg-black rounded-2xl overflow-hidden shadow-2xl border-2 border-white/20 z-10 transition-all hover:scale-105">
          <img 
            src={`https://ui-avatars.com/api/?name=${user?.name || 'Me'}&background=random`} 
            alt="You" 
